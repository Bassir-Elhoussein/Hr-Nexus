...
<html lang="en">
  <head>
    ...
    <body class="hold-transition sidebar-mini">
     ...
     Boolean Inad = null;
     try {
         Inad = (Boolean) session.getAttribute("loggedIn");
     } catch (Exception e) {
                              ...
                              <form action="../addEmployee" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="code" name="code" placeholder="Employee Code">
                                    </div>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="ESI" name="ESI" placeholder="ESI">
                                    </div>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="salnet" name="salnet" placeholder="salnet">
                                    </div>
                                    <div class="form-group">
